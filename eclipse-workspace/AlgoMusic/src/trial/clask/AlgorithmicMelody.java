...
public class AlgorithmicMelody extends JFrame implements ActionListener {
        ...
        JSynUnitVoiceInstrument ringModins;
        ...
        void initMusicShape() {
        	...
        	ringMod = new MusicShape(ringModins.getDimensionNameSpace());
        	ringMod.setInstrument(ringModins);
        	ringMod.setRepeats(1000);
        	ringMod.prefab();
        	ringMod.setName("Signal processor");
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (source == startButton) {
                buildMusicShape();
                ParallelCollection par = new ParallelCollection(myMusicShape, ringMod);
                par.launch(JMSL.now());
        ...
        public static void main(String[] args) {
            AlgorithmicMelody algorithmicMelody = new AlgorithmicMelody();
