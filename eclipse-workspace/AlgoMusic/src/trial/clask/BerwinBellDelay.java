...
public class BerwinBellDelay extends Circuit implements UnitVoice {
    ...
    InterpolatingDelay mDelay2;
    InterpolatingDelay mDelay3;
    ...
    public BerwinBellDelay() {
        ...
        add(mDelay2 = new InterpolatingDelay());
        add(mDelay3 = new InterpolatingDelay());
        ...
        mSineOsc3.output.connect(mDelay2.input);
        mSineOsc4.output.connect(mDelay3.input);
        ...
        mDelay2.output.connect(mOutputPassThrough.input);
        mDelay3.output.connect(mOutputPassThrough.input);
        mDelay1timePassThrough.output.connect(mDelay1.delay);
        mDelay2timePassThrough.output.connect(mDelay2.delay);
        mDelay3timePassThrough.output.connect(mDelay3.delay);
        // Setup
        ...
        mDelay2.allocate(44100);
        mDelay3.allocate(44100);
        delay1time.setup(0.01, 1.8394447240000003, 10.0);
        delay2time.setup(0.01, 0.34649295066963615, 10.0);
        delay3time.setup(0.01, 2.6899478189446597, 10.0);
    }
